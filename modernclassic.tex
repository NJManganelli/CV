...
\cventry{Jul 2022}{Ph.D. in Physics}{The University of California}{Riverside}{}{(Expected graduation)}  % Arguments not required can be left empty
...
\cvitem{Tools}{\textsc{ROOT}, Git, PyTorch (ML), Scikit-learn (ML), Scikit-hep (uproot, awkward), coffea}

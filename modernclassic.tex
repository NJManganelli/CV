...
%----------------------------------------------------------------------------------------
\section{Hard Skills}
\cvitem{Programming}{\textsc{Python} (Advanced), \textsc{C++} (Advanced), \textsc{git Continuous Integration}, \textsc{Python Packaging}, \textsc{Xilinx HLS}, \LaTeX, \textsc{zsh}, \textsc{Java} (Basic)}
...
\begin{itemize}
\item Maintainer of CMSSW emulation (C++) and eirmware (HLS) for the Global Track Trigger upgrade
...
\item Mentored and assisted 5 graduate students on their algorithm development within GTT, for Track Jets, Track MET, Track HT, and Meson reconstruction
\item Reviewed code for above algorithsm and provided feedback
...
\item Liased between CMS Offline Software Conveners and GTT group to facilitate faster and more efficient work
...
\item Assisted analysis groups in understanding and implementing the recommendations of the B-tagging and Vertexing Physics Object Group
\item Reviewed more than a dozen analyses for compliance with recommendations and both updates to and approval of b-tagging usage
\newline{}
\end{itemize}}
...
\item Paper submitted to Computing and Software for Big Science
\newline{}
\end{itemize}}
...
\cventry{Submitted}{C. Savard and N. Manganelli and ...}{Optimizing High Throughput Inference on Graph Neural Networks at Shared Computing Facilities with the NVIDIA Triton Inference Server}{\href{https://doi.org/10.48550/arXiv.2312.06838}{10.48550/arXiv.2312.06838}}{Computing and Software for Big Science}{}
...
\cventry{Jun 2024}{Lecturer}{USCMS/IRIS-HEP Analysis Software Training}{\href{https://indico.cern.ch/event/1383972/contributions/5825305/}{coffea lecture} \href{https://indico.cern.ch/event/1383972/contributions/5825307/}{and exercise} \href{https://indico.cern.ch/event/1383972/}{, https://indico.cern.ch/event/1383972/}}{}{}
\cventry{Dec 2023}{Lecturer}{2nd COFI Advanced Instrumentation and Analysis Techniques School}{\href{https://indico.cern.ch/event/1299889/timetable/}{Tools and Resources Needed for Machine Learning, https://indico.cern.ch/event/1299889/timetable/}}{}{}
...
\cventry{Jan 2021}{Lead Facilitator}{CMS Data Analysis School @ LPC 2021, Top Mass Exercise}{\href{https://indico.cern.ch/event/966368/timetable/}{https://indico.cern.ch/event/966368/timetable/}}{}{}
